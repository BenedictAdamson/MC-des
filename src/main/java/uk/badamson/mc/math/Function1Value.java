...
public final class Function1Value {
	 ...
	 * </p>
	 * <p>
	 * The {@link Function1Value} class has <i>value semantics</i>: this object
	 * is equivalent to another object if, and only if, the other object is also
	 * a {@link Function1Value} object, and the two objects have equivalent
	 * attributes.
	 * </p>
	 */
	@Override
