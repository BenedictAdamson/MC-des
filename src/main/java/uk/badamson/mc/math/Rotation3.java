...
public final class Rotation3 {
     ...
     * </ul>
     */
    public static final Rotation3 ZERO = new Rotation3(Quaternion.create(1, 0, 0, 0));
    ...
    public static Rotation3 createAxisAngle(ImmutableVector3 axis, double angle) {
        ...
        if (!smallAngle) {
            ...
            return new Rotation3(Quaternion.create(c, f * axis.get(0), f * axis.get(1), f * axis.get(2)));
        } else {
    ...
    private Rotation3(Quaternion versor) {
        this.versor = versor;
    }
