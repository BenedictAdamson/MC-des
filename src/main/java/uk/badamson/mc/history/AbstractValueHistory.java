 ...
 */
@NotThreadSafe
public final class AbstractValueHistory<VALUE> implements ValueHistory<VALUE> {
     ...
     */
    public AbstractValueHistory(@Nullable VALUE value) {
        firstValue = value;
    }
     ...
     */
    public AbstractValueHistory(@NonNull ValueHistory<VALUE> that) {
    ...
    public final boolean equals(Object that) {
        ...
        if (this == that)
            return true;
        if (that instanceof AbstractValueHistory) {
            @SuppressWarnings("unchecked")
            final AbstractValueHistory<VALUE> thatValueHistory = (AbstractValueHistory<VALUE>) that;
     ...
     * {@linkplain AbstractValueHistory#START_OF_TIME start of time}.</li>
     ...
     * {@linkplain AbstractValueHistory#START_OF_TIME start of time}), the
