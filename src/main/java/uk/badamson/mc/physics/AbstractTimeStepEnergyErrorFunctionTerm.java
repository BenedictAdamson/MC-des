 ...
 * </p>
 */
public final class AbstractTimeStepEnergyErrorFunctionTerm implements TimeStepEnergyErrorFunctionTerm {
	 ...
	 *             </ul>
	 */
	public AbstractTimeStepEnergyErrorFunctionTerm(ImmutableVector direction, double mass, int[] velocityTerm, int[] accelerationTerm) {
