...
public final class Newton2Error extends AbstractTimeStepEnergyErrorFunctionTerm {
	 ...
	 *            Which terms in the solution space vector correspond to the
	 *            components of the velocity vector of an advection (mass
	 *            transfer process) affecting the body.
	 *            {@code advectionVelocityTerm[j*n+i]} is the term of component
	 *            <var>i</var> of the velocity for advection <var>j</var>.
	 * @param forceOn
	 *            Whether one of the forces on this body has the <i>sense</i>
	 *            that a positive force component corresponds to a force that
	 *            increases that momentum component of this body.
	 *            {@code forceOn[k]} indicates that force <var>k</var> has a
	 *            positive sense.
	 * @param forceTerm
	 *            Which terms in the solution space vector correspond to the
	 *            components of the force vector of a force affecting the body.
	 *            {@code forceTerm[k*n+i]} is the term of component <var>i</var>
	 *            of force <var>k</var>.
	 ...
	 *             <li>If the length of {@code advectionMassRateTerm} is not
	 *             equal to the produce of the lengths of
	 *             {@code massTransferInto} and {@code velocityTerm}.</li>
	 ...
	 * 
	 * <ol>
	 * <li>The method uses the term index information to extract force, velocity
	 * and acceleration vectors and mass transfer rates from the given current
	 * state vector.</li>
	 * <li>It uses those values to calculate an error in obeying Newton's second
	 * law of motion, in terms of a force error.</li>
	 ...
	 * {@linkplain #getMassReference() characteristic time value}. That is the
	 * error term it returns.</li>
	 * </ol>
	 * 
	 * @param dedx
	 *            {@inheritDoc}
	 ...
	 * <p>
	 * Which terms in the solution space vector correspond to the components of
	 * the velocity vector of an advection (mass transfer process) affecting the
	 * body.
	 * </p>
	 * 
	 * @param j
	 ...
	 * <p>
	 * Which terms in the solution space vector correspond to the components of
	 * the force vector of a force affecting the body.
	 * </p>
	 * 
	 * @param k
	 ...
	 * <p>
	 * The functor uses this value to convert a force error into an energy
	 * error. It is tempting to use the time step size, but that will produce
	 * bad results if the time-step is small; it is better to use a value equal
	 * to the duration of a typical mass transfer process or of an impulse.
	 * </p>
	 * 
	 ...
	 * positive force component corresponds to a force that increases that
	 * momentum component of this body.
	 * </p>
	 * <p>
