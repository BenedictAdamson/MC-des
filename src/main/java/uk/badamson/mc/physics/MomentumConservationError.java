...
public final class MomentumConservationError extends AbstractTimeStepEnergyErrorFunctionTerm {
	 ...
	 * 
	 * <ol>
	 * <li>The method uses the term index information to extract force and
	 * velocity vectors and mass transfer rates from the given current state
	 * vector.</li>
	 * <li>It uses those values to calculate an extrapolated momentum for the
	 * new point in time.</li>
	 ...
	 * <li>From that it calculates an equivalent kinetic energy error, using
	 * mass of the body. That is the error term it returns.</li>
	 * </ol>
	 * 
	 * @param dedx
	 *            {@inheritDoc}
