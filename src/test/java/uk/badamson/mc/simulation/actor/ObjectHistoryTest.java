...
public class ObjectHistoryTest {
    ...
    public static <STATE> void assertInvariants(@Nonnull final ObjectHistory<STATE> history1,
        ...
        assertAll("Value semantics",
                ...
                () -> EqualsSemanticsTest.assertValueSemantics(history1, history2, "object", ObjectHistory::getObject),
                () -> EqualsSemanticsTest.assertValueSemantics(history1, history2, "end", ObjectHistory::getEnd),
    ...
    public class AddIncomingSignals {
        ...
        public void multipleThreads() {
            ...
            final ObjectHistory<Integer> history = new ObjectHistory<>(receiver, start, state0);
    ...
    public class AdvanceEnd {
        ...
        public class Event {
            ...
            private void test(@Nonnull final Duration start, @Nonnull final Duration whenSent,
                ...
                stateVerifierAtEvent.expectNext(Optional.ofNullable(eventState)).expectComplete().verify(FLUX_TIMEOUT);
                stateVerifierAtEnd.expectNext(Optional.ofNullable(eventState)).expectComplete().verify(FLUX_TIMEOUT);
                stateVerifierAfterEnd.expectNext(Optional.ofNullable(eventState)).verifyTimeout(FLUX_TIMEOUT);
            }
        ...
        public class NoEvents {
            ...
            private void test(@Nonnull final Duration start, @Nonnull final Duration end) {
                ...
                final Integer state = 0;
                final ObjectHistory<Integer> history = new ObjectHistory<>(object, start, state);
                final var stateVerifierAtEnd = StepVerifier.create(history.observeState(end));
                final var stateVerifierAfterEnd = StepVerifier.create(history.observeState(end.plusNanos(1)));
    ...
    public class CompareAndAddEvent {
        ...
        public class EmptySuccess {
            ...
            private void test(@Nonnull final UUID receiver, @Nonnull final UUID sender, @Nonnull final Duration end,
                ...
                stateVerifier.expectNext(Optional.ofNullable(state)).verifyTimeout(FLUX_TIMEOUT);
        ...
        public class Two {
            ...
            private void test(@Nonnull final Duration end, @Nonnull final Integer state0, @Nonnull final UUID signalId1,
                ...
                stateVerifier.expectNext(Optional.ofNullable(state2)).verifyTimeout(FLUX_TIMEOUT);
            }
    ...
    public class ComputeContinuation {
        ...
        public class TwoIncoming {
            ...
            public void a() {
                ...
                test(OBJECT_A, OBJECT_B, OBJECT_C, start, 0, whenSent1, SIGNAL_ID_A, whenSent2,
                        SIGNAL_ID_B);
            }
            ...
            public void b() {
                ...
                final Duration whenSent1 = WHEN_B;
                final Duration whenSent2 = WHEN_C;
                test(OBJECT_A, OBJECT_B, OBJECT_C, start, 0, whenSent1, SIGNAL_ID_B, whenSent2,
                        SIGNAL_ID_A);
            }
            ...
            public void close() {
                ...
                test(OBJECT_B, OBJECT_C, OBJECT_A, start, 1, whenSent1, SIGNAL_ID_B, whenSent2,
                        SIGNAL_ID_A);
            }
            ...
            public void simultaneousReception() {
                ...
                test(OBJECT_A, OBJECT_B, OBJECT_C, start, 0, whenSent1, signal1, whenSent2, signal2);
            }
    ...
    public class ObserveState {
        ...
        public class BeforeStart {
            ...
            private void test(@Nonnull final Duration start, @Nonnull final Duration when) {
                ...
                final var history = new ObjectHistory<>(OBJECT_A, start, 0);
    ...
    public class ReceiveNextSignal {
        ...
        public class First {
            ...
            private void test(@Nonnull final UUID sender, @Nonnull final UUID receiver, @Nonnull final Duration start,
                ...
                stateVerifier.expectNext(Optional.ofNullable(expectedState)).verifyTimeout(FLUX_TIMEOUT);
            }
        }// class
