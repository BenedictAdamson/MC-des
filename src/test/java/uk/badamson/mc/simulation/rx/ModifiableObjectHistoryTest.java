...
public class ModifiableObjectHistoryTest {
    ...
    public class Append {
        ...
        public void multiThreaded() {
            final var event0 = new TestEvent(new TimestampedId(OBJECT_A, WHEN_A), 0, Map.of());
            final var event1 = new TestEvent(new TimestampedId(OBJECT_A, WHEN_A.plusMillis(1)), 1,
                    Map.of());
            final var event2 = new TestEvent(new TimestampedId(OBJECT_A, WHEN_A.plusMillis(2)), 2,
                    Map.of());
        ...
        public class One {
            @Test
            public void a() {
                test(OBJECT_A, WHEN_A, 0, WHEN_A.plusMillis(10), 1);
            }

            @Test
            public void b() {
                test(OBJECT_B, WHEN_B, 3, WHEN_B.plusMillis(1500), 2);
            }

            @Test
            public void destruction() {
                test(OBJECT_A, WHEN_A, 0, WHEN_A.plusMillis(10), null);
            }

            @Test
            public void equalStates() {
                final var state = 0;
                test(OBJECT_A, WHEN_A, state, WHEN_A.plusMillis(10), state);
            }
    ...
    public class CompareAndAppend {
        ...
        public class AsExpected {
            ...
            @Test
            public void a() {
                test(OBJECT_A, WHEN_A, 0, WHEN_A.plusMillis(1), 1);
            }

            @Test
            public void b() {
                test(OBJECT_B, WHEN_B, 3, WHEN_B.plusMillis(1000), 2);
            }
        ...
        public class NotAsExpected {
            ...
            public void earlier() {
                ...
                test(OBJECT_A, lastEventTime, 0, expectedLastEventTime, 1,
                        lastEventTime.plusMillis(1), 2);
            }

            @Test
            public void equals() {
                final var lastEventTime = WHEN_B;
                final var lastEventState = 0;

                test(OBJECT_A, lastEventTime, lastEventState, lastEventTime, lastEventState,
                        lastEventTime.plusMillis(1), 2);
            }
            ...
            public void later() {
                ...
                test(OBJECT_A, lastEventTime, 1, expectedLastEventTime, 1,
                        expectedLastEventTime.plusMillis(1), 3);
            }
            ...
            public void sameTime() {
                ...
                test(OBJECT_B, lastEventTime, 0, lastEventTime, 1,
                        lastEventTime.plusMillis(1), 2);
            }
    ...
    public class ObserveEventsAfterAppend {
        ...
        @Test
        public void a() {
            testNonDestruction(OBJECT_A, WHEN_A, 0, WHEN_A.plusMillis(10), 1);
        }

        @Test
        public void b() {
            testNonDestruction(OBJECT_B, WHEN_B, 3, WHEN_B.plusMillis(1500), 2);
        }

        @Test
        public void destruction() {
            final UUID object = OBJECT_A;
            final var event0 = new TestEvent(new TimestampedId(object, WHEN_A), 0, Map.of());
    ...
    public class ObserveState {
        ...
        public class ReliableBetweenEvents {
            ...
            public void atTransition() {
                ...
                test(time0, time1, when, time2, 0, 1, 2);
            }
            ...
            public void betweenTransitions() {
                ...
                test(time0, time1, when, time2, 1, 2, 3);
            }
        ...
        public class UpdatedProvisionalConfirmedAsReliable {
            ...
            public void far() {
                ...
                testDistinct(time0, time1, when, time2, 3, 2, 1);
            }
            ...
            public void near() {
                ...
                testDistinct(time0, time1, when, time2, 0, 1, 2);
            }
    ...
    public class ObserveStateTransitionsAfterAppend {
        ...
        public void destruction() {
            ...
            final var expectedStateTransition = new ModifiableObjectHistory.TimestampedState<>(when1, (Integer) null);
            final var event0 = new TestEvent(new TimestampedId(object, when1.minusMillis(10)), 0,
                    Map.of());
            final var event1 = new TestEvent(new TimestampedId(object, when1), null, Map.of());
            final var history = new ModifiableObjectHistory<>(event0);
            history.append(event1);
            assert event1.getState() == null;
